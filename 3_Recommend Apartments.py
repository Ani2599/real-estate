...
location_df = pd.read_pickle(r'C:\pythonProject\location_distance.pkl')
cosine_sim1 = pickle.load(open('C:\pythonProject\cosine_sim1.pkl','rb'))
cosine_sim2 = pickle.load(open('C:\pythonProject\cosine_sim1.pkl','rb'))
cosine_sim3 = pickle.load(open('C:\pythonProject\cosine_sim1.pkl','rb'))
