...
with open('C:\pythonProject\df.pkl','rb') as file:
    df = pickle.load(file)

with open('C:\pythonProject\pipeline.pkl','rb') as file:
...
store_room = float(st.selectbox('Store Room', [0.0,1.1]))
...
if st.button('Predict'):
    ...
    st.text("The flat of the flat is between {} Cr and {} Cr".format(low,high))
